...
from utils import date_string_to_timestamp, get_content_list, write_dict_list_to_file, TeamScheduleScraperData
    ...
    for row in date_rows:
        ...
        for on, otc, pt in zip(opponent_names, opponent_tri_codes, primary_times):
            ...
            try:
                ...
                logging.error(str(e))
            game = {'team': team, 'opponent': on.lower(), 'opponent_tri_codes': otc, 'is_home_game': is_home_game, 'game_start_time': timestamp}
            games.append(game)
    return games

def write_games_to_file_system(team_data: TeamScheduleScraperData) -> None:
    """
